		...
		<div id="immolation_project_top_left">
			...
			<div id="immolation_project_subhead">
				...
				<table width="100%">
					<tbody>
						<tr>
							<td style="width: 25%;" class="preset" id="preset_1"><a href="javascript:immolation_project.preset(1)"><p>{$slides[8][6]|strip_tags}</a></p></td>
							<td style="width: 25%;" class="preset" id="preset_2"><a href="javascript:immolation_project.preset(2)"><p>{$slides[9][6]|strip_tags}</a></p></td>
							<td style="width: 25%;" class="preset" id="preset_3"><a href="javascript:immolation_project.preset(3)"><p>{$slides[10][6]|strip_tags}</a></p></td>
							<td style="width: 25%;" class="preset preset_last" id="preset_4"><a href="javascript:immolation_project.preset(4)"><p>{$slides[11][6]|strip_tags}</a></p></td>
						</tr>
					</tbody>
				</table>
